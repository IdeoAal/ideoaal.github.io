	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-12.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" action="daftarkan.php" method="post">
					...
					<p class="m-2 mb-1 pt-1 text-center">Sudah memiliki akun? <a href="login.php" class="text-danger" title="Masuk">Login</a></p>
				</form>
			</div>
		</div>
	</div>
